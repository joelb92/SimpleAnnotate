...
Color2::Color2(int red, int green, int blue)
{
	this->red = red;
	this->green = green;
	this->blue = blue;
...
Rect2::Rect2 (int upper, int left, int height, int width)
{
	this->upper = upper;
	this->left = left;
	this->height = height;
...
Rect2 Rect2::operator+ (Point2D p)
{
	Rect2 r_tmp;
...
int Rect2::checkOverlap(Rect2 rect)
{	
...
bool Rect2::isDetection(Rect2 eval, unsigned char *labeledImg, int imgWidth)
{
    bool isDet = false;
...
CvRect Rect2::getCvRect()
{
  return cvRect(upper, left, height, width);
}
...
Size2::Size2(int height, int width)
{
	this->height = height;
	this->width = width;
}

Size2 Size2::operator= (Rect2 r)
{
	height = r.height;
	width = r.width;
	return *this;
...
Point2D Point2D::operator= (Rect2 r)
{
	row = r.upper;
	col = r.left;
	return *this;
