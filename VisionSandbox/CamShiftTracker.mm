...
using namespace cv;
@implementation CamShiftTracker
...
//    trackBox.points(boxPoints);
//    std::vector<cv::Point2f> boxPoints2;
//    for(int i = 0; i < 4; i++) boxPoints2.push_back(boxPoints[i]);
//    return cv::boundingRect(boxPoints2);
//}
using namespace cv;
using namespace std;
